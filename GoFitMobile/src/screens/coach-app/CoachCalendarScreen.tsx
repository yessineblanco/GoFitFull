...
import { Calendar, Clock, Settings, User, XCircle, CheckCircle, Video } from 'lucide-react-native';
...
export const CoachCalendarScreen: React.FC = () => {
  ...
  const handleJoinCall = async (booking: Booking) => {
    ...
    if (roomId) {
      navigation.navigate('VideoCall', { bookingId: booking.id, videoRoomId: roomId });
    }
  };
